...
import { updateCashReportDetail } from "../../services/cashReportDetailService";
  ...
  export const CashReportDetailActionMenu = ({ data }: CashReportDetailActionMenuProps) => {
    const { getDetailsByCashReportId } = useCashReportStore();
    ...
    const handleDelete = async () => {
      ...
      getDetailsByCashReportId(data.cashReportId, setError);
